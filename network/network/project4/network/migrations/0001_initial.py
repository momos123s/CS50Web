# Generated by Django 5.0.4 on 2024-12-14 09:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UserIDs', models.ManyToManyField(null=True, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            name='Profile',
            fields=[
                ('ProfileID', models.BigAutoField(primary_key=True, serialize=False, unique=True)),
                ('following', models.ManyToManyField(null=True, related_name='follow', to=settings.AUTH_USER_MODEL)),
